...
class inference_framework():
    ...
    def whole_opt(self):
        ...
        inferred_params['average_of_v'] = self.study['ZNCC'].best_params['averafe_of_v']
        inferred_params['standard_deviation_of_v'] = self.study['ZNCC'].best_params['standard_deviation_of_v']
        inferred_params['arg1_of_repul_h'] = self.study['ZNCC'].best_params['arg1_of_repul_h']
        inferred_params['arg2_of_repul_h'] = self.study['ZNCC'].best_params['arg2_of_repul_h']
        inferred_params['arg1_of_repul_m'] = self.study['KL'].best_params['arg1_of_repul_m']
        inferred_params['arg2_of_repul_m'] = self.study['KL'].best_params['arg2_of_repul_m']
        inferred_params['average_of_p'] = self.study['ZNCC'].best_params['averafe_of_p']
        inferred_params['standard_deviation_of_p'] = self.study['ZNCC'].best_params['standard_deviation_of_p']
...
class inference_framework_detail():
    ...
    def __SAD_repul_m(self, trial):
        ...
        model = simulation.people_flow(self.people_num, self.v_arg, self.repul_h, [repul_m_arg1, repul_m_arg2], self.target,
                                self.R, self.min_p, self.p_arg,
                                self.wall_x, self.wall_y, self.in_target_d, self.dt,
                                len(self.maps) * self.save_params[1] + 1, self.save_format, self.save_params)
        result = model.simulate()
        result = np.asarray(result)
        ans = self.maps.copy()
        # ヒートマップの時間方向の長さが一致しないとき、後方の長い部分を切り捨てる
    ...
    def whole_opt(self):
        ...
        inferred_params = dict()
        inferred_params['average_of_v'] = self.study['KL'].best_params['averafe_of_v']
        inferred_params['standard_deviation_of_v'] = self.study['KL'].best_params['standard_deviation_of_v']
        inferred_params['arg1_of_repul_h'] = self.study['ZNCC'].best_params['arg1_of_repul_h']
        inferred_params['arg2_of_repul_h'] = self.study['ZNCC'].best_params['arg2_of_repul_h']
        inferred_params['arg1_of_repul_m'] = self.study['SAD'].best_params['arg1_of_repul_m']
        inferred_params['arg2_of_repul_m'] = self.study['SAD'].best_params['arg2_of_repul_m']
        inferred_params['average_of_p'] = self.study['KL'].best_params['averafe_of_p']
        inferred_params['standard_deviation_of_p'] = self.study['KL'].best_params['standard_deviation_of_p']
